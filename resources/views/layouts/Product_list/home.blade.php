...
<!-- Product -->
<link rel="stylesheet" href="{{asset('css/Product_list/flexslider.css')}}" type="text/css" media="screen" />
<!--//tags -->
...
<script type="text/javascript" src="{{asset('js/Product_list/imagezoom.js')}}"></script>
<!-- //js -->
<script type="text/javascript" src="{{asset('js/modernizr.custom.js')}}"></script>
...
<!-- Product -->
<script type="text/javascript" src="{{asset('js/Product_list/jquery.flexslider.js')}}"></script>
<script type="text/javascript" src="{{asset('js/Product_list/jquery.easing.min.js')}}"></script>
<!-- caer -->
