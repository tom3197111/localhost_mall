				...
				<div class="checkout-box-bd">
					...
					<div class="xm-box">
						...
						<div id="checkoutPayment">
							...
							<!-- 			<div class="box-hd LogisticsType_home_title">
											<h2 class="title">選擇取貨店家</h2>
										</div> -->
										...
										?>
										<li class="LogisticsType_home_mark {{$val['LogisticsType']}}">
											<input type="radio" name="Checkout[pay_id]"  value="{{$key}}}" >
											<input id="Logistics_tmp" type="hidden" value="{{$val['LogisticsType']}}">

											<button type="button"><img  src="{{$url}}" style="width: 100PX;height: 100PX"></a><span></span></button>
										</li>
										@endif
										@endforeach   
									...
									<!-- 		<p>
										...
										-->
										<button type="button"  onclick="location.href='Logistics/map/{{$val['LogisticsType']}}/{{$order[0]->order_id}}'"><img  src="{{$url}}" style="width: 100PX;height: 100PX"></a><span></span></button>
							...
							<!-- 宅配資料 --> 
							@foreach($post_fee as $val)
							@if($val->Types_of==0)
							<ul id="LogisticsType" class="checkout-option-lis clearfix J_optionList" >
								<li class="LogisticsType_home_mark_data ">											
									<div >
										<div style="border-style:double;" class="col-lg-12 col-sm-12 col-xs-12 ">
											<label>選擇物流:</label><br>&emsp; &emsp;<span style="font-size: 5px">
												<?php
												$url='http://www.fishing-tackle-mall.com/localhost_MALL_BACKEND/'. $val['logo_img'];
												?>
												<input id="Logistics_tmp" type="hidden" value="{{$val['LogisticsType']}}">
												<img src="{{$url}}" style="width: 30PX;height: 30pX"></span><br>
												<label>運費:</label><br>&emsp; &emsp;<span id='post_fee' style="font-size: 5px">{{$val['post_fee']}}</span><br>
											</div>
										</div>
									</li>
								</ul>
								...
								<!-- 到店取貨 店資料 -->
								<ul id="LogisticsType" class="checkout-option-lis clearfix J_optionList" >
									<li class="LogisticsType_mark_data ">											
										<div >
											<div style="border-style:double;" class="col-lg-12 col-sm-12 col-xs-12 ">
												<label>選擇店家:</label><br>&emsp; &emsp;<span style="font-size: 5px">
													...
													<label>運費:</label><br>&emsp; &emsp;<span id='CVSpost_fee' style="font-size: 5px">{{$logo_img['post_fee']}}</span><br>
												</div>
											</div>
										</li>
									</ul> 
										...
										<li class="LogisticsType_mark_home" >											
											<div class="box-bd">
												<div class="clearfix xm-address-list" id="checkoutAddrList">
													<dl class="item_address item "  >
														<dt>	
															<strong class="itemConsignee">姓名:
																...
																{{ Session::get('name')}}
															@endif</strong>
															<span class="itemTag tag">預設資料</span>
														</dt>
														<dd>
													...
													<dl class="item_address item insertadd ">
														<button type="button" class="close XX" data-id='{{$val->id}}'>x</button>
														<dt>	
															<strong class="itemConsignee">姓名:
																{{$val->name}}
															</strong>
									...
									<!-- 到店取貨_聯絡人資料-->
									<ul id="LogisticsType" class="checkout-option-liss clearfix J_optionList" >
										<li class="LogisticsType_store_store" >											
											<div class="box-bd">
												<div class="clearfix xm-address-list" id="checkoutAddrList">
													<dl class="item_address item "  >
														<dt>	
													...
													<dl class="item_address item_address_b  item "  data-toggle="modal" data-target="#zzz" style="height: 155px">
														<dd>
															<img src="{{asset('images/order/add_box-24px.svg')}}" width="100PX"><p>新增收貨人</p>
														</dd>
													</dl>
						...
						<div class="xm-box">
							...
							<div class="box-bd">
								<ul id="delivery_time" class="checkout-option-list clearfix J_optionList ">
									...
									<li class="item ">
										<input type="radio"  name="Checkout[best_time]" value="1"><p>不限送貨時間<span>周一至周日</span></p></li>
										<li class="item ">
											<input type="radio"  name="Checkout[best_time]" value="2"><p>工作天送貨<span>周一至周五</span></p></li>
											<li class="item ">
												<input type="radio"  name="Checkout[best_time]" value="3"><p>周休、國定假日送貨<span>周六至周日</span></p></li>                       
											</ul>
										</div>
									</div>
									<!-- 送货时间 END-->
										...
										<div class="xm-box">
											...
											<div class="box-bd">
												<ul id="invoice" class="checkout-option-list checkout-option-invoice clearfix J_optionList J_optionInvoice">
													...
													<li class="item ">
														<input type="radio"   value="2" name="Checkout[invoice]">
														<p>普通發票（紙質）</p>
													</li>
												</ul>
												...
												<div class="invoice-info nvoice-info-1" id="checkoutInvoiceElectronic" style="display:none;">
													...
													<p>機票抬頭：個人</p>
													<p>
														<span class="hide"><input type="radio" value="4" name="Checkout[invoice_type]"     id="electronicPersonal" class="invoiceType"></span>
													</p>
												</div>
											</div>
										</div>                </div>
													...
													<div class="checkout_details_area mt-50 clearfix">
															...
															<div class="order-details-confirmation">
																...
																<table class="table table-hover table-responsive" id=""  >
																	...
																	<tr class="tableHorizontalBottomLine"  data-price="{{$order_list->price}}" data-key="id" data-id="{{$order_list->id}}" >
																		...
																		<td data-key="quantity" data-quantity="{{$order_list->quantity}}"  title="Quantity">
																			<input type="number" min="1" style="width: 70px;" class="quantity" value="{{$order_list->quantity}}"/></td> 
														...
														<div class="checkout-count clearfix">
															<div class="checkout-count-extend xm-add-buy">
																...
																<textarea cols="50" rows="5" id='buy_message'></textarea>
															</div>
															...
															<div class="checkout-price">
																<ul>
																	...
																	<li>
																		運費：<span id="postageDesc"></span>
																	</li>
																</ul>
																<p class="checkout-total">應付總額：<span><strong id="TotalPrice"></strong>元</span></p>
															</div>
															<!--  -->
														</div>
													</div>
